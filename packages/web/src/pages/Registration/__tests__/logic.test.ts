import { loginValidation, passwordValidation, confirmPasswordValidation, showPass, validateStatusCheck} from '../logic'
...
describe('confirmPasswordValidation', () => {
  ...
  test('should be function typeof function', () => {
    expect(typeof confirmPasswordValidation).toBe('function');
  });
});
